"""
Django settings for research_manager project.
...
SECRET_KEY = 'django-insecure-q-q(9m!$!_@xxzv@@h9-b14qq*i3pfqh^5(2skskjn1(9v&)9%'
...
ROOT_URLCONF = 'research_manager.urls'
...
WSGI_APPLICATION = 'research_manager.wsgi.application'
